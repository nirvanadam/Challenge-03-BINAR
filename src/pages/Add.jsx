      ...
      <form className="flex flex-col gap-5 my-2 mx-3 md:mx-5 lg:mx-10 border border-slate-400 p-3" onSubmit={onSubmit}>
        <div className="flex">
          ...
          <input
            ...
            className="w-full border py-1 px-2 rounded-r-sm outline-none transition duration-200 placeholder:text-sm placeholder:font-light placeholder:transition placeholder:duration-500 focus:placeholder:-translate-x-48 focus:border-[#0D28A6] invalid:focus:border-red-600"
          />
        </div>
        <button type="submit" className="bg-[#263238] rounded-sm text-cyan-400 py-2">
          Submit
        </button>
      </form>
    </>
